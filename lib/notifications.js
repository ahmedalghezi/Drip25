...
//      console.log("Scheduling temperature reminder for:", target.format("YYYY-MM-DD HH:mm:ss"))
...
//  Alert.alert("bleedingPrediction : ", Moment(bleedingPrediction[0][0],'YYYY-MM-DD'))
  if (bleedingPrediction.length > 0) {
    ...
    const reminderDate = predictedBleedingStart
      ...
      .minutes(0)
      .seconds(0)
//    Alert.alert("Scheduling period reminder for:", reminderDate.format("YYYY-MM-DD HH:mm:ss"))
    if (reminderDate.isAfter()) {
//      console.log("Scheduling period reminder for:", reminderDate.format("YYYY-MM-DD HH:mm:ss"))
