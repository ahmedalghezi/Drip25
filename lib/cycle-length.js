export function getCycleLengthStats(cycleLengths) {
  ...
  if (cycleLengths.length > 1) {
    ...
    cycleLengthStats.stdDeviation =
      ...
      200
//     cycleLengthStats.stdDeviation = cycleLengthStats.stdDeviation/2
//      cycleLengthStats.meanWithStdDev = `${cycleLengthStats.mean} +/- ${cycleLengthStats.stdDeviation}`
  } else {
    cycleLengthStats.stdDeviation = null
//    cycleLengthStats.meanWithStdDev = `${cycleLengthStats.mean}`
  }
